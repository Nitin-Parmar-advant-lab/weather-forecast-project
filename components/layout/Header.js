...
export default function Header() {
    return (
        <header className="relative z-50 flex flex-col sm:flex-row justify-between items-center p-4 sm:p-2 px-4 sm:px-8 mx-4 sm:mx-8 mt-4 sm:mt-8 bg-black/10 backdrop-blur-xl border border-white/5 rounded-2xl gap-4 sm:gap-0">
